...
// Variables para guardar los estados de los LEDs
    ...
    function toggleLED1() {
        ...
        if (ledState1 === 'off') {
			...
			ledButton1.style.backgroundColor = 'green'; // Color verde cuando se enciende el LED 1
        } else {
            ledState1 = 'off';
    ...
    function toggleLED2() {
        ...
        if (ledState2 === 'off') {
			...
			ledButton2.style.backgroundColor = 'yellow'; // Color amarillo cuando se enciende el LED 2
        } else {
            ledState2 = 'off';
    ...
    function toggleLED3() {
        ...
        if (ledState3 === 'off') {
			...
			ledButton3.style.backgroundColor = 'red'; // Color rojo cuando se enciende el LED 3
        } else {
            ledState3 = 'off';
    ...
    function toggleLED4() {
        ...
        if (ledState4 === 'off') {
			...
			ledButton4.style.backgroundColor = 'blue'; // Color azul cuando se enciende el LED 4
        } else {
            ledState4 = 'off';
